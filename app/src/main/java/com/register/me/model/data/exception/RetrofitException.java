...
import com.register.me.model.data.api.ApiConstants;
import com.register.me.model.data.api.model.ErrorModel;
...
public class RetrofitException extends Exception {
    ...
    private void extractHttpError() {
         ...
         * When {@link com.register.data.util.Util.getErrorMessage()} is called it will use message
